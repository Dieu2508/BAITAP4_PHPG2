...
<body>
	 ...
	 ?>
	  ...
	  <div align="center">
            <form action="" method="get">
                Search: <input type="text" name="search" placeholder="<?php echo $_REQUEST['search'];  ?>" />
	...
	<div class="container">
		<table width="1000px" border="1px">
			<button class="btn btn-outline-primary" name="them" type="button" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-plus-circle"></i>Thêm</button>
			  	...
			  	<div class="modal-dialog" role="document">
			    	<div class="modal-content">
			        	...
			        	<form action="" method="get">
				        	...
				        	<label>Title<input type="text" name="inputgia" value="" required></label>
				        	<label>Author<input type="text" name="inputtitle" value="" required></label>
				        	<label>Price<input type="text" name="inputtacgia" value="" required></label>
				        	<label>Year<input type="text" name="inputyear" value="" required></label>
				        	<div class="modal-footer">
				        		<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
				        		<button type="submit" class="btn btn-primary" name="submitadd">Save</button>
				      		</div>
			        	</form>
			      		</div>
			    	</div>
			...
			foreach ($file as $lsa) { ?>
				<tr class="content default" >
					...
					<td><?php echo $lsa->price ; ?></td>
					<td><?php echo $lsa->year; ?></td>
					<td>
						
	                        
	                       	<button  class="btn btn-outline-danger" type="button" data-toggle="modal" data-target="#exampleModal<?php echo $lsa->id; ?>"><i class="fas fa-pencil-alt"></i>Sửa</button>
						  	...
						  	<div class="modal-dialog" role="document">
						    	<div class="modal-content">
						        	...
						        	<form action="" method="get">
							        	...
							        	<label>Title<input type="text" name="editgia" value="<?php echo $lsa->price ; ?>" required></label>
							        	<label>Author<input type="text" name="edittitle" value="<?php echo $lsa->title; ?>" required></label>
							        	<label>Price<input type="text" name="edittacgia" value="<?php echo $lsa->author; ?>" required></label>
							        	<label>Year<input type="text" name="edityear" value="<?php echo $lsa->year; ?>" required></label>
							        	<div class="modal-footer">
							        		<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
							        		<button type="submit" class="btn btn-primary" name="submitedit">Save</button>
							      		</div>
						        	</form>
						      		</div>
						    	</div>
